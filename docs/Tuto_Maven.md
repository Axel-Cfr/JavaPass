...
Sur Linux, le système de gestion de paquets (apt, dnf, yum, ...) s'occupe de tout :
```
sudo (apt, dnf, yum, ...) install maven

# Puis vérifier que l'installation à fonctionnée

mvn --version
```
Et c'est tout, Linux > Windows !
